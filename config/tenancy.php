...
return [
    ...
    'models' => [
        ...
        'tenant' => Tenant::class, // Update: billydekid - use custom Tenant model
    ...
    'identification' => [
        ...
        'default_middleware' => Middleware\InitializeTenancyBySubdomain::class, // Update: billydekid - use subdomain identification as default
    ...
    'bootstrappers' => [
        ...
        Bootstrappers\RedisTenancyBootstrapper::class, // Note: phpredis is needed -- Update: billydekid - keep this enabled 

        // Adds support for the database session driver
        // Bootstrappers\DatabaseSessionBootstrapper::class, // Update: billydekid - disabled, using redis sessions
    ...
    'database' => [
        ...
        'tenant_host_connection_name' => env('DB_CONNECTION_TENANTADMIN', 'tenant_admin'), // Update: billydekid - use admin connection for tenant creation/deletion
        ...
        'managers' => [
            ...
            // Update: billydekid - enabled, use permission controlled pgsql manager
